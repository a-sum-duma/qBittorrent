...
public:
    ...
    using QSortFilterProxyModel::mapToSource; // prevent hiding by TorrentContentFilterModel::mapToSource
    QModelIndexList mapToSource(const QModelIndexList &proxyIndexes) const; // an overload for lists
